...
class BuildColor {
  ...
  ///```
  Color get bottomAppBar => Theme.of(_context).bottomAppBarTheme.color??Colors.transparent;
  ...
  ///```
  Color get selectedRow => Colors.transparent;
  ...
  ///```
  Color get toggleableActive => Colors.blue;
}
